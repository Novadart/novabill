...
public class LocaleWidgets {
	...
	public static ValidatedListBox createProvinceListBox(String defaultItem) {
		ValidatedListBox listBox = new ValidatedListBox(GlobalBundle.INSTANCE.validatedWidget(), defaultItem, I18N.INSTANCE.notEmptyValidationError());
	...
	public static ValidatedListBox createCountryListBoxItalyOnly(String defaultText){
		ValidatedListBox listBox = new ValidatedListBox(GlobalBundle.INSTANCE.validatedWidget(), defaultText, I18N.INSTANCE.notEmptyValidationError());
