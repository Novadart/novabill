...
public class InvoiceActivity extends BasicActivity {
	...
	private void start(InvoicePlace invoicePlace, final AcceptsOneWidget panel){
	...
	private void start(EstimationPlace estimationPlace, final AcceptsOneWidget panel){
		final InvoiceView iv = getClientFactory().getInvoiceView();
		iv.setPresenter(this);
