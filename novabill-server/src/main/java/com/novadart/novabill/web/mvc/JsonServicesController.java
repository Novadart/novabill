...
public class JsonServicesController {
	...
	@ResponseBody
	public Pair<PriceListDTO, List<PriceListDTO>> fetchSelectCommodityForDocItemOpData(@PathVariable Long clientID) throws NotAuthenticatedException, NoSuchObjectException, DataAccessException {
