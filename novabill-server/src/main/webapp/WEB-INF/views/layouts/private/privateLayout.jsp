...
<head>
	...
	<link href="private/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
	<link href="private/plugins/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet" type="text/css" />
	<link href="private/plugins/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css"/>
	<link href="private/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css" media="screen"/>
	<link href="private/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
	<!-- END PAGE LEVEL PLUGIN STYLES -->
	<!-- BEGIN PAGE LEVEL STYLES --> 
	<link href="private/css/pages/tasks.css" rel="stylesheet" type="text/css" media="screen"/>
...
<body class="page-header-fixed">
	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<img src="private/img/logo.png" alt="logo" />
				</a>
				<!-- END LOGO -->
				<!-- BEGIN RESPONSIVE MENU TOGGLER -->
				<a href="javascript:;" class="btn-navbar collapsed" data-toggle="collapse" data-target=".nav-collapse">
				<img src="private/img/menu-toggler.png" alt="" />
				</a>          
				...
				<ul class="nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height:250px">
									<li>
										...
										<span class="photo"><img src="./private/img/avatar2.jpg" alt="" /></span>
										<span class="subject">
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo"><img src="./private/img/avatar3.jpg" alt="" /></span>
										<span class="subject">
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo"><img src="./private/img/avatar1.jpg" alt="" /></span>
										<span class="subject">
					...
					<li class="dropdown user">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" src="private/img/avatar1_small.jpg" />
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									<div id="site_statistics_loading">
										<img src="private/img/loading.gif" alt="loading" />
									</div>
												...
												<div class="scroller" style="height:290px" data-always-visible="1" data-rail-visible1="1">
													<div class="row-fluid">
														<div class="span6 user-info">
															<img alt="" src="private/img/avatar.png" />
															<div class="details">
																<div>
							...
							<div class="portlet">
								...
								<div class="portlet-body" id="chats">
									<div class="scroller" style="height:435px" data-always-visible="1" data-rail-visible1="1">
										<ul class="chats">
											<li class="in">
												<img class="avatar" alt="" src="private/img/avatar1.jpg" />
												<div class="message">
													<span class="arrow"></span>
											...
											<li class="out">
												<img class="avatar" alt="" src="private/img/avatar2.jpg" />
												<div class="message">
													<span class="arrow"></span>
											...
											<li class="out">
												<img class="avatar" alt="" src="private/img/avatar3.jpg" />
												<div class="message">
													<span class="arrow"></span>
	...
	<!-- BEGIN CORE PLUGINS -->   
	<script src="private/plugins/jquery-1.10.1.min.js" type="text/javascript"></script>
	...
	<script src="private/plugins/jqvmap/jqvmap/jquery.vmap.js" type="text/javascript"></script>   
	<script src="private/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js" type="text/javascript"></script>
	<script src="private/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js" type="text/javascript"></script>
	<script src="private/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js" type="text/javascript"></script>
	<script src="private/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js" type="text/javascript"></script>
	<script src="private/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js" type="text/javascript"></script>
	<script src="private/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js" type="text/javascript"></script>  
	<script src="private/plugins/flot/jquery.flot.js" type="text/javascript"></script>
	<script src="private/plugins/flot/jquery.flot.resize.js" type="text/javascript"></script>
	<script src="private/plugins/jquery.pulsate.min.js" type="text/javascript"></script>
	<script src="private/plugins/bootstrap-daterangepicker/date.js" type="text/javascript"></script>
	<script src="private/plugins/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>     
	<script src="private/plugins/gritter/js/jquery.gritter.js" type="text/javascript"></script>
	<script src="private/plugins/fullcalendar/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
	<script src="private/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.js" type="text/javascript"></script>
	<script src="private/plugins/jquery.sparkline.min.js" type="text/javascript"></script>  
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="private/scripts/app.js" type="text/javascript"></script>
	<script src="private/scripts/index.js" type="text/javascript"></script>
	<script src="private/scripts/tasks.js" type="text/javascript"></script>        
