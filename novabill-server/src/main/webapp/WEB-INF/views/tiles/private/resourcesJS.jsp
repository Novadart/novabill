...
<script src="${novabillDepsUrl}/angular/angular-cookies.js?v=${project.version}"></script>
...
<script src="${novabillDepsUrl}/angular-ui/ui-bootstrap-tpls-0.13.0.js?v=${project.version}" type="text/javascript"></script>
