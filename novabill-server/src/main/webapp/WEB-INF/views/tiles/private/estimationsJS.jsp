...
<script src="${privateAssetsUrl}/pages/scripts/estimations-controllers.js" type="text/javascript"></script>
<script src="${privateAssetsUrl}/pages/scripts/estimations.js" type="text/javascript"></script>
