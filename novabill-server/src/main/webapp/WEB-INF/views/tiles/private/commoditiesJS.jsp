...
<script src="${privateAssetsUrl}/pages/scripts/commodities-controllers.js" type="text/javascript"></script>
<script src="${privateAssetsUrl}/pages/scripts/commodities.js" type="text/javascript"></script>
