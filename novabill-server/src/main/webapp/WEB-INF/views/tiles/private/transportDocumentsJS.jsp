...
<script src="${privateAssetsUrl}/novabill/scripts/transport-documents-controllers.js" type="text/javascript"></script>
<script src="${privateAssetsUrl}/novabill/scripts/transport-documents.js" type="text/javascript"></script>
