...
<script src="${privateAssetsUrl}/pages/scripts/transport-documents-controllers.js" type="text/javascript"></script>
<script src="${privateAssetsUrl}/pages/scripts/transport-documents.js" type="text/javascript"></script>
