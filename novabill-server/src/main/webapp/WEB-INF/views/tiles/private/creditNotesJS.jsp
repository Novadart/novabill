...
<script src="${privateAssetsUrl}/pages/scripts/credit-notes-controllers.js" type="text/javascript"></script>
<script src="${privateAssetsUrl}/pages/scripts/credit-notes.js" type="text/javascript"></script>
