...
.config(['$translateProvider', function($translateProvider){
	...
	$translateProvider.translations('it_IT', {
		...
		LR_TRANSPORTER_CREATE : 'You created the transporter <strong><a href="{{link}}">{{transporterName}}</a></strong>',
		LR_TRANSPORTER_CREATE_DEL : 'You created the transporter <strong>{{transporterName}}</strong>',
		LR_TRANSPORTER_DELETE : 'You deleted the transporter <strong>{{transporterName}}</strong>',
		LR_TRANSPORTER_UPDATE : 'You updated the transporter <strong><a href="{{link}}">{{transporterName}}</a></strong>',
		LR_TRANSPORTER_UPDATE_DEL : 'You updated the transporter <strong>{{transporterName}}</strong>',
		MOBILE : 'Cellulare',
