...
public aspect EstimationServiceActionsAspect extends DBLoggerAspect {
	...
	pointcut add(EstimationDTO estimationDTO) : 
		call(public Long com.novadart.novabill.service.web.EstimationService.add(..)) && args(estimationDTO);
	
	pointcut remove(Long businessID, Long clientID, Long id) :
		call(public void com.novadart.novabill.service.web.EstimationService.remove(..)) && args(businessID, clientID, id);
	
	pointcut update(EstimationDTO estimationDTO) :
		call(public void com.novadart.novabill.service.web.EstimationService.update(..)) && args(estimationDTO);
