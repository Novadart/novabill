...
public class EstimationCellImpl extends QuickViewCell<EstimationDTO> implements EstimationCell {
	...
	private void onOpenEstimationClicked(EstimationDTO estimation) {
	...
	/* (non-Javadoc)
	 * @see com.novadart.novabill.frontend.client.widget.list.impl.EstimationCell#onPdfClicked(com.novadart.novabill.shared.client.dto.EstimationDTO)
	 */
	@Override
	...
	private void onConvertToInvoiceClicked(final EstimationDTO estimation) {
	...
	/* (non-Javadoc)
	 * @see com.novadart.novabill.frontend.client.widget.list.impl.EstimationCell#setPresenter(com.novadart.novabill.frontend.client.presenter.Presenter)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.novadart.novabill.frontend.client.widget.list.impl.EstimationCell#setEventBus(com.google.web.bindery.event.shared.EventBus)
	 */
	@Override
