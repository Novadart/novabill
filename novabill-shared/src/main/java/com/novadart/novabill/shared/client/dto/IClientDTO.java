...
public interface IClientDTO {
	...
	public abstract Long getDefaultPaymentTypeID();

	public abstract void setDefaultPaymentTypeID(Long defaultPaymentTypeID);
	...
	public abstract void setContact(ContactDTO contact);
